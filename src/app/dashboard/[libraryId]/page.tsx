...
export default async function LibraryDashboardPage({ params }: PageProps) {
        ...
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground mt-2 text-lg">
                        {library.description || "Track your progress and mastery."}
                    </p>
                </div>
            ...
            <div className="grid gap-4 md:grid-cols-12 md:grid-rows-2">
                ...
                <Card className="md:col-span-8 md:row-span-1 border-muted bg-secondary/10">
                    ...
                    <CardContent>
                        <QuickActions libraryId={libraryId} />
                    </CardContent>
                </Card>
            </div>
        </div>
